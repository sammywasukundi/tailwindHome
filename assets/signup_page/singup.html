            ...
            <div class="bg-gray-200 flex rounded-2xl shadow-2xl max-w-4xl p-5 items-center contrast-100">
                <div class="md:w-2/3 px-16">
                    ...
                    <form class="flex flex-col gap-4" action="">
                        ...
                        <input type="file" class="p-2 rounded-xl w-full" name="fichier" placeholder="Choose a file" >
                        <button class="bg-yellow-700 rounded-xl text-white py-2 hover:shadow-inner transform hover:scale-110 transition ease-in duration-500">Sign up</button>
                    ...
                    <div class="mt-3 flex justify-between text-xs items-center">
                        ...
                        <button class="py-2 px-5 bg-white border rounded-xl hover:shadow-inner transform hover:scale-110 transition ease-in duration-500">Register</button>
                    </div> -->
